...
''' % (str(k + 1), str(k + 1))
	...
	table create_new_map_%s{
		...
		size = 64;
		const entries = {
			{true,0} : create_with_true_%s(0b00000000000000000000000000000001);
			{true,1} : create_with_true_%s(0b00000000000000000000000000000010);
			{true,2} : create_with_true_%s(0b00000000000000000000000000000100);
			{true,3} : create_with_true_%s(0b00000000000000000000000000001000);
			{true,4} : create_with_true_%s(0b00000000000000000000000000010000);
			{true,5} : create_with_true_%s(0b00000000000000000000000000100000);
			{true,6} : create_with_true_%s(0b00000000000000000000000001000000);
			{true,7} : create_with_true_%s(0b00000000000000000000000010000000);
			{true,8} : create_with_true_%s(0b00000000000000000000000100000000);
			{true,9} : create_with_true_%s(0b00000000000000000000001000000000);
			{true,10} : create_with_true_%s(0b00000000000000000000010000000000);
			{true,11} : create_with_true_%s(0b00000000000000000000100000000000);
			{true,12} : create_with_true_%s(0b00000000000000000001000000000000);
			{true,13} : create_with_true_%s(0b00000000000000000010000000000000);
			{true,14} : create_with_true_%s(0b00000000000000000100000000000000);
			{true,15} : create_with_true_%s(0b00000000000000001000000000000000);
			{true,16} : create_with_true_%s(0b00000000000000010000000000000000);
			{true,17} : create_with_true_%s(0b00000000000000100000000000000000);
			{true,18} : create_with_true_%s(0b00000000000001000000000000000000);
			{true,19} : create_with_true_%s(0b00000000000010000000000000000000);
			{true,20} : create_with_true_%s(0b00000000000100000000000000000000);
			{true,21} : create_with_true_%s(0b00000000001000000000000000000000);
			{true,22} : create_with_true_%s(0b00000000010000000000000000000000);
			{true,23} : create_with_true_%s(0b00000000100000000000000000000000);
			{true,24} : create_with_true_%s(0b00000001000000000000000000000000);
			{true,25} : create_with_true_%s(0b00000010000000000000000000000000);
			{true,26} : create_with_true_%s(0b00000100000000000000000000000000);
			{true,27} : create_with_true_%s(0b00001000000000000000000000000000);
			{true,28} : create_with_true_%s(0b00010000000000000000000000000000);
			{true,29} : create_with_true_%s(0b00100000000000000000000000000000);
			{true,30} : create_with_true_%s(0b01000000000000000000000000000000);
			{true,31} : create_with_true_%s(0b10000000000000000000000000000000);
			{false,0} : create_with_false_%s(0b11111111111111111111111111111110);
			{false,1} : create_with_false_%s(0b11111111111111111111111111111101);
			{false,2} : create_with_false_%s(0b11111111111111111111111111111011);
			{false,3} : create_with_false_%s(0b11111111111111111111111111110111);
			{false,4} : create_with_false_%s(0b11111111111111111111111111101111);
			{false,5} : create_with_false_%s(0b11111111111111111111111111011111);
			{false,6} : create_with_false_%s(0b11111111111111111111111110111111);
			{false,7} : create_with_false_%s(0b11111111111111111111111101111111);
			{false,8} : create_with_false_%s(0b11111111111111111111111011111111);
			{false,9} : create_with_false_%s(0b11111111111111111111110111111111);
			{false,10} : create_with_false_%s(0b11111111111111111111101111111111);
			{false,11} : create_with_false_%s(0b11111111111111111111011111111111);
			{false,12} : create_with_false_%s(0b11111111111111111110111111111111);
			{false,13} : create_with_false_%s(0b11111111111111111101111111111111);
			{false,14} : create_with_false_%s(0b11111111111111111011111111111111);
			{false,15} : create_with_false_%s(0b11111111111111110111111111111111);
			{false,16} : create_with_false_%s(0b11111111111111101111111111111111);
			{false,17} : create_with_false_%s(0b11111111111111011111111111111111);
			{false,18} : create_with_false_%s(0b11111111111110111111111111111111);
			{false,19} : create_with_false_%s(0b11111111111101111111111111111111);
			{false,20} : create_with_false_%s(0b11111111111011111111111111111111);
			{false,21} : create_with_false_%s(0b11111111110111111111111111111111);
			{false,22} : create_with_false_%s(0b11111111101111111111111111111111);
			{false,23} : create_with_false_%s(0b11111111011111111111111111111111);
			{false,24} : create_with_false_%s(0b11111110111111111111111111111111);
			{false,25} : create_with_false_%s(0b11111101111111111111111111111111);
			{false,26} : create_with_false_%s(0b11111011111111111111111111111111);
			{false,27} : create_with_false_%s(0b11110111111111111111111111111111);
			{false,28} : create_with_false_%s(0b11101111111111111111111111111111);
			{false,29} : create_with_false_%s(0b11011111111111111111111111111111);
			{false,30} : create_with_false_%s(0b10111111111111111111111111111111);
			{false,31} : create_with_false_%s(0b01111111111111111111111111111111);
		}
	}
''' % (str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1),
       str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1), str(k + 1),
